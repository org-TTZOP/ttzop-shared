...
const UI_T = {
  ...
  it: {
    book_title: "Prenota: {name}", book_date: "Data", book_time: "Ora", book_loading: "Cerchiamo orari liberi…", book_none: "Nessun orario libero in questo giorno", book_confirm: "Prenotare il {d} alle {t}?", book_done: "Fatto! Appuntamento il {d} alle {t}. Dettagli nell'area clienti.", book_taken: "Questo orario è appena stato preso. Scegline un altro.", book_login: "Accedi all'area clienti per prenotare", book_err: "Non è riuscito. Riprova più tardi", book_seats: "Posti:", book_full: "Posti esauriti — scegli un altro orario", grp_upto: "Gruppo fino a {n}", trpack_sub_label: "Sottodominio del tuo sito (chi riceve le traduzioni)", form_err_trpack: "Indica il sottodominio del sito per il pacchetto di traduzioni", dep_next: "Prossima partenza", dep_left: "posti liberi", tk_title: "Biglietto", tk_valid: "Valido", tk_cancelled: "Annullato", tk_past: "Passato", tk_notfound: "Biglietto non trovato", tk_seats: "Posti", route_teaser: "Percorso ({n}) · ~{t}", route_plan: "Piano del percorso", route_stop: "Tappa", route_transfer: "🚶 Trasferimento ~{t}", route_gmaps: "Apri il percorso in Google Maps", unit_h: "h", unit_min: "min", show_more:'Mostra altro', show_less:'Nascondi', view_toggle:'Schede / Elenco',
