...
const UI_T = {
  ...
  it: {
    book_title: "Prenota: {name}", book_date: "Data", book_time: "Ora", book_loading: "Cerchiamo orari liberi…", book_none: "Nessun orario libero in questo giorno", book_confirm: "Prenotare il {d} alle {t}?", book_done: "Fatto! Appuntamento il {d} alle {t}. Dettagli nell'area clienti.", book_taken: "Questo orario è appena stato preso. Scegline un altro.", book_login: "Accedi all'area clienti per prenotare", book_err: "Non è riuscito. Riprova più tardi", book_seats: "Posti:", book_full: "Posti esauriti — scegli un altro orario", grp_upto: "Gruppo fino a {n}", tk_title: "Biglietto", tk_valid: "Valido", tk_cancelled: "Annullato", tk_past: "Passato", tk_notfound: "Biglietto non trovato", tk_seats: "Posti", route_teaser: "Percorso ({n}) · ~{t}", route_plan: "Piano del percorso", route_stop: "Tappa", route_transfer: "🚶 Trasferimento ~{t}", route_gmaps: "Apri il percorso in Google Maps", unit_h: "h", unit_min: "min", show_more:'Mostra altro', show_less:'Nascondi', view_toggle:'Schede / Elenco',
  ...
  zh: {
    book_title: "预约：{name}", book_date: "日期", book_time: "时间", book_loading: "正在查找空闲时间…", book_none: "当天没有空闲时间", book_confirm: "预约 {d} {t}？", book_done: "完成！已为您预约 {d} {t}。详情请见客户中心。", book_taken: "该时段刚被占用，请另选一个。", book_login: "请先登录客户中心再预约", book_err: "操作失败，请稍后再试", book_seats: "人数：", book_full: "名额已满 — 请选择其他时间", grp_upto: "团体最多 {n} 人", tk_title: "票", tk_valid: "有效", tk_cancelled: "已取消", tk_past: "已过期", tk_notfound: "未找到票", tk_seats: "座位", route_teaser: "路线（{n}）· 约{t}", route_plan: "路线计划", route_stop: "站点", route_transfer: "🚶 前往下一站 约{t}", route_gmaps: "在 Google 地图中打开路线", unit_h: "小时", unit_min: "分钟", show_more:'显示更多', show_less:'收起', view_toggle:'卡片 / 列表',
